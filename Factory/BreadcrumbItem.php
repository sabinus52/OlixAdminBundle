<?php
/**
 * Classe de chaque élément composant le fil d'Ariane
 *
...
class BreadcrumbItem implements SidebarItemInterface
{
    ...
    */
     ...
     * @var \Olix\AdminBundle\Factory\BreadcrumbItem[]
     */
    ...
    */
    ...
    /**
     * @param string $label
     * @return \Olix\AdminBundle\Factory\BreadcrumbItem
     */
    ...
    */
    ...
    {
        $child = new BreadcrumbItem($name, $options);
    ...
    /**
     * @return multitype:\Olix\AdminBundle\Factory\BreadcrumbItem
     */
     ...
     * @return \Olix\AdminBundle\Factory\BreadcrumbItem|NULL
     */
